...
- (id)initWithText:(NSString *)text{
    if (self = [super init]) {
        text =[XZTool isBlankString:text]?@"网络连接错误":text;
        _text = [text copy];
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textSize.width + 30 , textSize.height  + 20 )];
